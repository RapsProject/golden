...
const DREAM_MAJORS = [
  'Informatics Engineering (IUP)',
  'Electrical Engineering (IUP)',
  'Industrial Engineering (IUP)',
  'Engineering Management (IUP)',
  'Civil Engineering (IUP)',
  'Mechanical Engineering (IUP)',
  'Chemical Engineering (IUP)',
  'Aerospace Engineering (IUP)',
  'Geodesy and Geomatics Engineering (IUP)',
  'Environmental Engineering (IUP)',
  'Mining Engineering (IUP)',
  'Petroleum Engineering (IUP)',
  'Biomedical Engineering (IUP)',
  'Materials Engineering (IUP)',
  'Naval Architecture and Marine Engineering (IUP)',
  'Ocean Engineering (IUP)',
  'Physics (IUP)',
  'Mathematics (IUP)',
];

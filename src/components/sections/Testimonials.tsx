...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      'Most students underestimate the English reasoning component. GoldenPath makes you comfortable thinking in English under time pressure.',
  },
];
      ...
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 text-base md:text-lg max-w-2xl mx-auto">
            GoldenPath is crafted together with question writers and successful IUP ITB students — giving you
            guidance from people who have passed the exam themselves.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {testimonials.map(({ name, role, quote }) => (
            ...
            >
              <p className="text-slate-700 text-sm md:text-base mb-6 italic">&ldquo;{quote}&rdquo;</p>

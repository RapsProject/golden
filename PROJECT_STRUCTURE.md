...
This is a landing page for an IUP International Class entrance exam preparation platform, built with React, Vite, and Tailwind CSS.
...
- ✅ **Hero** (`components/sections/Hero.tsx`)
  - Badge: "#1 IUP International Class Preparation Platform"
